...
extension NumberParser on String {
  ...
  int get chineseNumber {
    ...
    final Pair<String?, String?> qp = wp.b?.apartBy('千') ?? Pair(null, null);
    final String q = qp.a ?? '零';
    final Pair<String?, String?> bp = qp.b?.apartBy('百') ?? Pair(null, null);
    final String b = bp.a ?? '零';
    final Pair<String?, String?> sp = bp.b?.apartBy('十') ?? Pair(null, null);
